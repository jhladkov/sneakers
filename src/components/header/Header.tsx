                ...
                <div className="header-inner">
                    ...
                    <nav className='header-navigation'>
                        ...
                        <ul className='header-navigation-list'>
                            <NavLink activeClassName="selected" className='header-navigation-list-link' to='/like'>
                            ...
                            <NavLink activeClassName="selected" className='header-navigation-list-link' to='/purchases'>
                                <svg className='header-navigation-list-svg nav-svg' viewBox="0 0 24 24">
